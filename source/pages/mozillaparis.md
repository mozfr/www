---
layout: default
title: Compte Twitter de Mozilla Paris
---
<section id="contrib">
...
<p>
    ...
    employés du bureau désirant aider à diffuser la promotion des évènements se déroulant dans les locaux de Mozilla à
    Paris.<br/>
    Cette page contient une liste de questions récurrentes et leurs réponses.
</p>

<h3 id="support">Comment obtenir de l’assistance technique&nbsp;?</h3>
<p>
    Pour de l’assistance sur tous les programmes maintenus par Mozilla, vous pouvez poster sur le
...
<p>
    ...
    locaux parisiens&nbsp;!<br>
    À partir du 30 juin 2019 et pour quelques mois, Mozilla Paris ne sera pas capable d’accueillir
    d’évènements dans ses bureaux.
</p>

<p>
    Pour que votre évènement soit accueilli au sein des bureaux de Paris, veuillez envoyer un
    descriptif le plus complet possible de celui-ci à cette liste de diffusion&nbsp;:
    <a href="mailto:paris-events@mozilla.org?subject=Contact pour évènement">paris-events@mozilla.org</a>. Ce descriptif devrait
    ...
    Si nous ne vous donnons pas de réponses sous deux semaines, n’hésitez pas à nous recontacter.
</p>

<p>
    La sécurité de Mozilla vérifiera l’identité des participants (permis de conduire, passeport et pièce d’identité).
    Dans le cas contraire, l’accès sera refusé au participant.
    Ainsi nous recommandons aux organisateurs d’en informer les participants pour éviter des surprises.
    De rares exceptions pourront être apportées à cette règle. Les raisons devront être exposées clairement par
